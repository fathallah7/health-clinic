<x-email.layout :title="'Appointment Confirmation'">
    <h2 style="margin-top:0; color:#2c3e50; font-size:1.5em;">Hello {{ $appointment->patient->name }},</h2>

    <p style="font-size:1.1em; color:#34495e;">Your appointment has been <strong style="color:#27ae60;">successfully
            confirmed</strong>.</p>
    ...
    <div style="text-align:center; margin-top:28px;">
        <a href="{{ url('/appointments/cancel/' . $appointment->id) }}"
            style="display:inline-block; padding:14px 28px; background:#e74c3c; color:#fff; text-decoration:none; border-radius:8px; font-weight:bold; font-size:1.1em; box-shadow:0 2px 8px rgba(231,76,60,0.08); transition:background 0.2s;">
            Cancel Appointment
        </a>
    </div>
